...
function cargar_data() {
    ...
    ajax.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            last = JSON.parse(data[0]);
            previous = JSON.parse(data[1]);
            confirmed = JSON.parse(data[2]);
            actualice();
            timer();
            get_total();
            if_number();
...
function get_total() {
    ...
    ajax.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            var data = JSON.parse(this.responseText);
            document.getElementById("totalbets").innerHTML = data['total'];
            document.getElementById("wagered").innerHTML = data['wagered'] / 100000000 + ' BCH';
...
function get_total1() {
    ...
    ajax.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            var data = JSON.parse(this.responseText);
            document.getElementById("totalbets").innerHTML = total_bets;
            document.getElementById("wagered").innerHTML = total_wag / 100000000 + ' BCH';
            cargar();
        }
    }
};
...
function cargar() {
    ...
    push.done(function(data) {
        if (data['modo'] == 0) {
            ...
            previous = last;
            last = data;
            previous['time'] = last['previous_time'];
            actualice();
            fletch_txs();
            cargar();
            if_number();
...
function push_tx(data) {
    return $.ajax({
        async: true,
        type: "POST",
        url: "gettxdetails.php",
        data: ({
            tx: data
        }),
        dataType: "json"
...
function actualice() {
    if (blockstatus == 0) {
        document.getElementById("winner").innerHTML = last['winner'];
        document.getElementById("winner1").innerHTML = previous['winner'];
        document.getElementById("winner2").innerHTML = confirmed['winner'];
        document.getElementById("height").innerHTML = last['height'];
        document.getElementById("hash").innerHTML = last['hash'];
        document.getElementById("confs").innerHTML = 1;
    } else if (blockstatus == 1) {
        document.getElementById("winner").innerHTML = last['winner'];
        document.getElementById("winner1").innerHTML = previous['winner'];
        document.getElementById("winner2").innerHTML = confirmed['winner'];
        document.getElementById("height").innerHTML = previous['height'];
        document.getElementById("hash").innerHTML = previous['hash'];
        document.getElementById("confs").innerHTML = 2;
        document.getElementById("confs1").innerHTML = "0" + previous['time'];
    } else if (blockstatus == 2) {
        document.getElementById("winner").innerHTML = last['winner'];
        document.getElementById("winner1").innerHTML = previous['winner'];
        document.getElementById("winner2").innerHTML = confirmed['winner'];
        document.getElementById("height").innerHTML = confirmed['height'];
        document.getElementById("hash").innerHTML = confirmed['hash'];
        document.getElementById("confs").innerHTML = 3;
        document.getElementById("confs1").innerHTML = "0" + confirmed['time'];
    };
